...
:warning: Please note that the following examples are provided **"AS IS"** and only serve as a proof of concept to show possible uses of the [DattoAPI](https://github.com/Celerium/Datto-PowerShellWrapper) PowerShell wrapper.
